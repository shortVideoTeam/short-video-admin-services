...
public class HuomaiVideoController extends BaseController {
	 ...
	 */
	@ApiOperation("更新用户状态")
	@PreAuthorize("@ss.hasPermi('business:video:changeStatus')")
	@Log(title = "视频信息", businessType = BusinessType.UPDATE)
	@PostMapping("/changeStatus")
	public AjaxResult<Void> changeStatus(@RequestBody HuomaiVideoEditBo bo) {
		return toAjax(iHuomaiVideoService.changeUserStatusById(bo) ? 1 : 0);
	}
