 ...
 */
@Service
public class HuomaiUserFollowServiceImpl
    extends ServiceImpl<HuomaiUserFollowMapper, HuomaiUserFollow>
    implements IHuomaiUserFollowService {

  @Autowired private HuomaiUserFollowMapper userFollowMapper;

  @Override
  public TableDataInfo<HuomaiUserFollowDetailVo> queryById(HuomaiUserFollowQueryBo bo) {
    List<HuomaiUserFollowDetailVo> list =
        userFollowMapper.queryDetailList(PageUtils.buildPage(), bo);
    return PageUtils.buildDataInfo(list);
  }

  @Override
  public TableDataInfo<HuomaiUserFollowVo> queryPageList(HuomaiUserFollowQueryBo bo) {
    List<HuomaiUserFollowVo> list = userFollowMapper.queryList(PageUtils.buildPage(), bo);
    return PageUtils.buildDataInfo(list);
  }
